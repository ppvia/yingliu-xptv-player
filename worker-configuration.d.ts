/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config cloudflare/wrangler.jsonc` (hash: cf442aae0bbe8f6f6da8f9713fb0ef47)
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./cloudflare-dist/worker");
	}
